...
import { companyLinks, companyLinks2, productLinks } from "@/components/layout/nav-links";
		...
		<NavigationMenu className="hidden md:flex">
			<NavigationMenuList>
				<NavigationMenuItem className="bg-transparent">
					...
					<NavigationMenuContent className="bg-muted/50 p-1 pe-1.5 dark:bg-background">
				...
				<NavigationMenuItem>
					...
					<NavigationMenuContent className="bg-muted/50 p-1 pe-1.5 pb-1.5 dark:bg-background">
